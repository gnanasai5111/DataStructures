...
1. Map the characters in hashmap.Check if the mapped character is equal to value at current index and also check if mapped value is already present as value.
